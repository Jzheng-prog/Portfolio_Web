  ...
  return (
    <div className='pb-20 pt-36'>
        ...
        <div>
            ...
            <Spotlight className='top-left left-full h-[80vh] w-[50vw]' fill='purple'/>
        ...
        <div className='flex justify-center relative my-20 z-10'>
            <div className='max-w-[89vw] md:maxc-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                ...
                <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">Hi, Im John</p>
                
                <a href="">
                    <Button title="Show More" icon={<FaLocationArrow/>} position='right'/>
                </a>
            </div>
        </div>
