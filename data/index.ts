...
export const fullstackProjs = [
  {
    id: 1,
    title: "Shoptify-Clone",
    tech: "Next.JS, React, Stripe, Supabase, PostgreSQL, Tailwind",
    des: "This project is a full-stack music streaming application that replicates popular features and functionalities of Spotify. This application showcases modern web development techniques and best practices",
    img: "/spotifyClone.PNG",
    iconLists: [],
    link: "https://github.com/Jzheng-prog/spotify-clone",
  },
  {
    id: 2,
    title: "Netflix-Clone",
    tech: "React, Tailwind CSS, Next.JS, Prisma, MongoDB, NextAuth",
    des: "A fully functional Netflix-inspired streaming platform built using modern web technologies. This project includes user authentication, video playback, and a beautiful, responsive UI.",
    img: "/netflixHero.PNG",
    iconLists: [],
    link: "https://github.com/Jzheng-prog/netflix-clone",
  },
  {
    id: 3,
    title: "OnlineShop",
